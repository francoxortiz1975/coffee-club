...
export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/75 backdrop-blur-md border-t border-cafe-dark/10 flex justify-around items-start pt-3 pb-6 z-50 max-w-md mx-auto">
